...
tiempos_python = []
with open("TIEMPOS\\tiempos_bubblesort_python.txt", "r") as archivo_tiempo_python:
...
tiempos_cmasmas = []
with open("TIEMPOS\\tiempos_bubblesort_c++.txt", "r") as archivo_tiempo_cmasmas:
...
plt.title('Comparación de tiempos de ejecución del algoritmo BUBBLE SORT') 
plt.legend()
