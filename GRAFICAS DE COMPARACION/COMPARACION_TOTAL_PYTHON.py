...
tiempos_bubble= []
with open("TIEMPOS\\tiempos_bubblesort_python.txt", "r") as archivo_tiempo_bubble:
    for linea in archivo_tiempo_bubble:
        tiempo = float(linea.split(":")[1].strip().split()[0])
        tiempos_bubble.append(tiempo)

tiempos_counting = []
with open("TIEMPOS\\tiempos_countingsort_python.txt", "r") as archivo_tiempo_counting:
    for linea in archivo_tiempo_counting:
        tiempo = float(linea.split(":")[1].strip().split()[0])
        tiempos_counting.append(tiempo)

tiempos_heap = []
with open("TIEMPOS\\tiempos_heapsort_python.txt", "r") as archivo_tiempo_heap:
    for linea in archivo_tiempo_heap:
        tiempo = float(linea.split(":")[1].strip().split()[0])
        tiempos_heap.append(tiempo)

tiempos_insertion = []
with open("TIEMPOS\\tiempos_insertionsort_python.txt", "r") as archivo_tiempo_insertion:
    for linea in archivo_tiempo_insertion:
        tiempo = float(linea.split(":")[1].strip().split()[0])
        tiempos_insertion.append(tiempo)

tiempos_merge = []
with open("TIEMPOS\\tiempos_mergesort_python.txt", "r") as archivo_tiempo_merge:
...
tiempos_quick = []
with open("TIEMPOS\\tiempos_quicksort_python.txt", "r") as archivo_tiempo_quick:
    for linea in archivo_tiempo_quick:
        tiempo = float(linea.split(":")[1].strip().split()[0])
        tiempos_quick.append(tiempo)

tiempos_selection = []
with open("TIEMPOS\\tiempos_selectionsort_python.txt", "r") as archivo_tiempo_selection:
...
plt.title('Comparación de los algoritmos de ordenamiento en Python')
plt.legend()
