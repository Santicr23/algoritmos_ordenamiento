...
tiempos_python = []
with open("TIEMPOS\\tiempos_mergesort_python.txt", "r") as archivo_tiempo_python:
...
tiempos_cmasmas = []
with open("TIEMPOS\\tiempos_mergesort_c++.txt", "r") as archivo_tiempo_cmasmas:
...
plt.title('Comparación de tiempos de ejecución del algoritmo MERGE SORT')
plt.legend()
