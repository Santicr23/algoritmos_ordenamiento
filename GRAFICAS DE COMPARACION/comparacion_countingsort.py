...
tiempos_python = []
with open("TIEMPOS\\tiempos_countingsort_python.txt", "r") as archivo_tiempo_python:
...
tiempos_cmasmas = []
with open("TIEMPOS\\tiempos_countingsort_c++.txt", "r") as archivo_tiempo_cmasmas:
...
plt.xlabel('Tamaños de archivos')
plt.ylabel('Tiempo de ejecución (segundos)')
plt.title('Comparación de tiempos de ejecución del algoritmo COUNTING SORT') #nota: la etiqueta si aparece en la grafica pero en pantalla completa
plt.legend()
